...
check "/fa/signup" "signup form (one form, both types)"
check "/en/signup" "signup form (en)"
check "/fa/signup/buyer" "buyer signup"
check "/en/signup/buyer" "buyer signup (en)"
check "/fa/signup/artist" "artist/designer registration"
check "/en/signup/artist" "artist/designer registration (en)"
check "/fa/creators/join" "old designer path (redirects)"
