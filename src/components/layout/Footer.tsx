...
export function Footer() {
  ...
  const cols = [
    ...
    { title: dict.footer.company, links: [[dict.nav.about, "/about"], [dict.nav.projects, "/projects"], [dict.nav.custom, "/custom"], [dict.nav.stories, "/stories"], [dict.nav.becomeCreator, "/signup/artist"], [locale === "fa" ? "میز کار فروش هنرمند" : "Artist sales studio", "/artist/marketplace"]] },
